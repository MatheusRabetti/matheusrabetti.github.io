...
```{r beta-density, dependson = "setup"}
sim %>% filter(a == 81) %>%
    ggplot(aes(x, y, color = Parameters)) + geom_line() +
    xlim(0, .5) + ylab("Density of beta") + xlab("Batting Average")
```
